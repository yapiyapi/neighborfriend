...
public class Adapter_home_myband extends RecyclerView.Adapter<Adapter_home_myband.CustomViewHolder> {

    private String 밴드;

    private List<home_cell> myband_list;
    private int seq; private String thumnail_url, title;

    public Adapter_home_myband(ArrayList<home_cell> list) {
        myband_list = list;
    }
    ...
    public void onBindViewHolder(@NonNull CustomViewHolder holder, int position) {
        seq = myband_list.get(position).getSeq();
        thumnail_url = myband_list.get(position).getThumnail_url();
        title = myband_list.get(position).get제목();
        // 이미지
        ...
        public CustomViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    /** 게시물 식별번호 **/
                    int 밴드번호 = myband_list.get(posi).getSeq();
